...
class Client
{
    ...
    */
     ...
     * @return array
     */
    public function fetch($protected_resource_url, $params = array(), $http_method = self::HTTP_METHOD_GET, array $http_headers = array(), $form_content_type = self::HTTP_FORM_CONTENT_TYPE_MULTIPART, $token = array() ) {
        ...
        return $this->executeRequest($protected_resource_url, $params, $http_method, $http_headers, $form_content_type, $token);
    }
     ...
     * @return array
     */
    private function executeRequest($url, $params = array(), $http_method = self::HTTP_METHOD_GET, array $http_headers = null, $form_content_type = self::HTTP_FORM_CONTENT_TYPE_MULTIPART, $token = array())
    {
        $curl_options = array(
